                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-sm bg-white rounded-lg p-4 border border-slate-200">
                      ...
                      <span className="font-bold text-slate-900 text-lg">
                        {countries[tattooData.country as keyof typeof countries]?.name} - {(countries[tattooData.country as keyof typeof countries]?.regions as Record<string, string>)[tattooData.region]}
                      </span>
                    </div>
                    <div className="flex justify-between items-center text-sm bg-white rounded-lg p-4 border border-slate-200">
